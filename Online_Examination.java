...
class login extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        String validUsername = "21BCE8883";
        String validPassword = "yq8x57fl";

            if (!userValue.isEmpty() && !passValue.isEmpty()){
                 if (userValue.equals(validUsername) && passValue.equals(validPassword)) {
            ...
            JOptionPane.showMessageDialog(this, "Please enter both username and password.", "Empty Fields", JOptionPane.ERROR_MESSAGE);
       }
    }
}
